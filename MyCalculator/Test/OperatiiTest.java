...
class OperatiiTest {
    ...
    public void testAdunare() {
        ...
        //assertNotNull(rez);
        assertEquals(p3.toString(), Operatii.adunare(p1, p2).toString());
    }
    ...
    public void testScadere(){
       ...
       // assertNotNull(rez);
        assertEquals(p3.toString(), Operatii.scadere(p1, p2).toString());
    }
    ...
    public void testInmultire(){
        ...
        //assertNotNull(rez);
        assertEquals(p3.toString(), Operatii.inmultire(p1, p2).toString());
    }
    ...
    public void testDerivare(){
        ...
        assertNotNull(rez);
        assertEquals(p3.toString(), Operatii.dervivare(p1).toString());
    }
    ...
    public void testIntegrare(){
        ...
        assertNotNull(rez);
        assertEquals(p3.toString(), Operatii.integrare(p1).toString());
    }
